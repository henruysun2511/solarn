...
export const assignmentResultSchema = z.object({
  ...
  gradedAt: z.string().optional().nullable(),
...
export const myAssignmentResultParamsSchema = z.object({
  page: z.coerce.number().optional().default(1),
  limit: z.coerce.number().optional().default(10),
  search: z.string().optional(),
  classId: z.string().uuid().optional(),
...
export type MyAssignmentResultParams = z.infer<typeof myAssignmentResultParamsSchema>;
