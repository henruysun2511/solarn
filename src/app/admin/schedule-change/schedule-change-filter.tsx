...
interface ScheduleChangeFilterProps {
  onSearch: (value: string) => void;
  onFilterChange: (filters: Partial<ScheduleChangeParams>) => void;
  onRowsPerPageChange: (value: number) => void;
}

export function ScheduleChangeFilter({ onSearch, onFilterChange, onRowsPerPageChange }: ScheduleChangeFilterProps) {
