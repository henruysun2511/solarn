...
import { ReEnrollmentRequestParams } from "@/schemas/request.schema";
import { ArrowUpDown, SearchIcon, SortAsc, SortDesc, XIcon } from "lucide-react";
import { useState } from "react";

interface ReEnrollmentFilterProps {
  onSearch: (value: string) => void;
  onFilterChange: (filters: Partial<ReEnrollmentRequestParams>) => void;
  onRowsPerPageChange: (value: number) => void;
}

export function ReEnrollmentFilter({
  onSearch,
  onFilterChange,
  onRowsPerPageChange,
}: ReEnrollmentFilterProps) {
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        >
          ...
          <SelectContent data-role="admin">
            ...
            <SelectItem value={RequestStatus.PENDING}>Chờ xử lý</SelectItem>
