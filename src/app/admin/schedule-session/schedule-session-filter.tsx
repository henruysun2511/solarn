    ...
    return (
        <div className="p-5 border-b border-gray-200 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex flex-wrap items-center gap-3">
                ...
                >
                    <SelectTrigger data-role="admin" className="w-[200px] h-10 rounded-2xl border-gray-200 bg-white font-medium text-sm">
                        <SelectValue placeholder="Chọn lớp học" />
                    </SelectTrigger>
                    <SelectContent data-role="admin" className="rounded-2xl max-h-[300px]">
                ...
                {/* Lọc theo Ca học (shiftCode) */}
                <Select
                    value={params.shiftCode || "ALL"}
                    onValueChange={(val) => onFilterChange({ shiftCode: val === "ALL" ? undefined : val, page: 1 })}
                >
                    <SelectTrigger data-role="admin" className="w-[160px] h-10 rounded-2xl border-gray-200 bg-white font-medium text-sm">
            ...
            <div className="flex items-center gap-4 ml-auto lg:ml-0">
                ...
                >
                    <SelectTrigger data-role="admin" className="w-[140px] h-10 rounded-2xl border-gray-200 bg-white font-medium text-sm">
                        <SelectValue />
                    </SelectTrigger>
                    <SelectContent data-role="admin" className="rounded-2xl">
