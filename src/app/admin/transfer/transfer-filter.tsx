...
interface TransferFilterProps {
  ...
  onFilterChange: (filters: Partial<TransferRequestParams>) => void;
  onRowsPerPageChange: (value: number) => void;
}

export function TransferFilter({ onSearch, onFilterChange, onRowsPerPageChange }: TransferFilterProps) {
    ...
    <div className="p-5 border-b border-gray-200 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
      <div className="flex flex-wrap items-center gap-3">
        <form onSubmit={handleSearch} className="relative w-[280px]">
          ...
          <Input
            placeholder="Tên học sinh hoặc mã đơn..."
