...
import {
  ...
  ENROLLMENT_STATUS_SHORT_LABELS,
...
for (const key of Object.keys(ENROLLMENT_STATUS_CONFIG)) {
  const cfg = ENROLLMENT_STATUS_CONFIG[key];
  statusBadge[key] = {
    ...cfg,
    label: ENROLLMENT_STATUS_SHORT_LABELS[key] || cfg.label,
  };
}
