...
export const getColumns = ({ onDelete }: ColumnProps): ColumnDef<CourseResource>[] => [
  {
    accessorKey: "title",
    ...
    cell: ({ row }) => (
      <div className="flex justify-center">
        <Button
          variant="ghost"
          size="sm"
          className="h-9 rounded-xl text-red-500 hover:text-red-700 hover:bg-red-50 font-bold text-xs gap-1.5"
