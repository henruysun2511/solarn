  ...
  return (
    <div className="p-5 border-b border-gray-200 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
      <div className="flex flex-wrap items-center gap-3">
        ...
        >
          <SelectTrigger data-role="teacher" className="w-[200px] h-10 rounded-2xl border-gray-200 bg-white font-medium text-sm">
            <SelectValue placeholder="Chọn lớp học" />
          </SelectTrigger>
          <SelectContent data-role="teacher" className="rounded-2xl max-h-[300px]">
            ...
            {classes.map((cls: any) => (
              <SelectItem key={cls.classId} value={cls.classId} className="rounded-xl font-bold">
                {cls.classCode || cls.classId?.substring(0, 8)}
              </SelectItem>
            ))}
          </SelectContent>
        </Select>
        ...
        >
          <SelectTrigger data-role="teacher" className="w-[160px] h-10 rounded-2xl border-gray-200 bg-white font-medium text-sm">
      ...
      <div className="flex items-center gap-4 ml-auto lg:ml-0">
        ...
        >
          <SelectTrigger data-role="teacher" className="w-[140px] h-10 rounded-2xl border-gray-200 bg-white font-medium text-sm">
            <SelectValue />
          </SelectTrigger>
          <SelectContent data-role="teacher" className="rounded-2xl">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 font-medium">
          ...
          >
            <SelectTrigger data-role="teacher" className="w-[80px] h-10 rounded-2xl border-gray-200 bg-white font-bold">
              <SelectValue />
            </SelectTrigger>
            <SelectContent data-role="teacher" className="rounded-2xl">
