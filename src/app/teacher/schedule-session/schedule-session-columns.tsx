...
import { CalendarIcon, ClockIcon, MoreVerticalIcon, CalendarClockIcon } from "lucide-react";

interface ColumnProps {
  onScheduleChange: (session: ScheduleSession) => void;
}

export const getColumns = ({ onScheduleChange }: ColumnProps): ColumnDef<ScheduleSession>[] => [
  {
      ...
      <div className="text-right pr-6">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="rounded-2xl p-1.5">
            <DropdownMenuItem
              onClick={() => onScheduleChange(row.original)}
